...
def stochastic_vol_mean_reversion_generator(annual_drift, annual_sd, years, edge_probability, edge_intesity):
    '''
...
sim_data, expected_profit_pa, expected_edge_sharpe_ratio= stochastic_vol_mean_reversion_generator(0.0, 0.1, 60, 0.55, 0.2)  
sim_data.to_csv('data/ae2.csv', header = False, index=True, encoding='utf-8')
