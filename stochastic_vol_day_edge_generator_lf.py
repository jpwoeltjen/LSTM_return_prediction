...
def stochastic_vol_day_edge_generator_lf(annual_drift, annual_sd, years, edge_probability, edge_intesity):
    '''
...
sim_data, expected_profit_pa, expected_edge_sharpe_ratio= stochastic_vol_day_edge_generator_lf(0.0, 0.1, 30, 0.9, 1)  
sim_data.to_csv('data/ae4.csv', header = False, index=True, encoding='utf-8')
