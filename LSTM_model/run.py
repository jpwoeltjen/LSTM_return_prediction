...
# Load dataset
    ...
    # path ='/data/1m_duka_eur_2008-2017.csv'
    ...
    periods_in_year = 252#527040#330756#for annualization of Sharpe and CAGR
    #Define hyperparameters
    train_pct = 0.2 #as a percentage of the whole dataset length
    val_pct = 0.5 #pct of test set used for validation ( NOT as a percentage of the whole dataset length)
    ...
    learning_rate_decay = [0.00]#, 0.001, 0.005]
    dropout = [0.2]
    threshold = [0, 0.5]
